...
export const highlightSelected = id => {
    ...
    let previousElement = document.querySelector('.results__link--active');
    if(previousElement) {
        previousElement.classList.remove('results__link--active');
    };

    let element = document.querySelector(`.results__link[href="#${id}"]`);
    if(element) {
